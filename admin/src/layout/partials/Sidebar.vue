<template>
  <section class="app-sidebar">
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <div
        class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top text-center"
      >
      ...
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          <span
            class="nav-link"
            v-b-toggle="'post'"
            :class="{ active: subIsActive('/posts') }"
          >
            <span class="menu-icon">
          ...
          <b-collapse accordion="sidebar-accordion" id="post">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item">
                <router-link class="nav-link" to="/posts/list/"
                  >Все записи</router-link
                >
              </li>
              <li class="nav-item">
                <router-link class="nav-link" to="/stock/favorite/"
                  >Черновики</router-link
                >
              </li>
              <li class="nav-item">
                <router-link class="nav-link" to="/posts/dividends/"
                  >Опубликованные
                </router-link>
              </li>
            </ul>
